package ua.instrumentation.example;

import ua.instrumentation.agent.InstrumentationAgent;
...
public class InstrumentationExample {
    ...
    public static void main(String[] arguments) {
        ...
        String[] stringArray1 = {emptyString, string};
        String[] stringArray2 = {emptyString, string, "com.baeldung"};
        ...
        printObjectSize(stringArray1);
        printObjectSize(stringArray2);
        ...
        printObjectSize(byteList);
        printObjectSize(byteList.get(0));
    }
